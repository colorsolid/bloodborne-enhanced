    ...
    if GetEventStatus(999):
        ...
        while True:
            ...
            if GetEventStatus(12100961) or GetEventStatus(12100761):
                ...
                if (GetEventStatus(12110000 + 290 * 10 + 2 * 2) == 0 or GetEventStatus(12110000 + 290 * 10 + 2 * 2 + 1) == 0) and GetEventStatus(12100862) == 1:
...
def t290112_x48():
    while True:
        ...
        if not GetTalkListEntryResult() or not IsTalkExclusiveMenuOpen():
            ...
            SetEventState(12902838, 1)
            return 0
        elif GetTalkListEntryResult() == 2:
            SetEventState(12902858, 1)
            return 0
        elif GetTalkListEntryResult() == 3:
            SetEventState(12902878, 1)
            return 0
