...
def t241001_x48():
    while True:
        ...
        if not GetTalkListEntryResult() or not IsTalkExclusiveMenuOpen():
            ...
            SetEventState(12411758, 1)
            return 0
        elif GetTalkListEntryResult() == 2:
            SetEventState(12411858, 1)
            return 0
...
def t241001_x20(flag2=_, flag3=_, action1=_):
    ...
    if GetEventStatus(12100968) and flag2 * 10 + flag3 == 10103: # 10003
        if not GetEventStatus(70002413):
            ...
            assert not IsGenericDialogOpen()
            return 1
    elif GetEventStatus(12100968) and flag2 * 10 + flag3 == 10105: # 10005
        if not GetEventStatus(70002401):
            ...
            assert not IsGenericDialogOpen()
            return 1
    elif GetEventStatus(12100968) and flag2 * 10 + flag3 == 10121: # 10021
