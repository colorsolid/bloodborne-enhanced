...
def t290110_1():
    """State 0,1"""
    t290110_x1(flag1=6000, flag2=6000, actionbutton1=6100, actionbutton2=6101, flag3=290, flag4=0)
    Quit()
...
def t290110_x1(flag1=6000, flag2=6000, actionbutton1=6100, actionbutton2=6101, flag3=290, flag4=0):
    """State 0"""
    while True:
        """State 1"""
        call = t290110_x3(actionbutton1=actionbutton1, actionbutton2=actionbutton2, flag3=flag3, flag4=flag4)
...
def t290110_x3(actionbutton1=6100, actionbutton2=6101, flag3=290, flag4=0):
    """State 0"""
    while True:
        """State 2"""
        ...
        if not GetEventStatus(10007810 + flag3 * 10000 + flag4 * 20):
            ...
            SetTalkTime(0.33)
            """State 5"""
            call = t290110_x4(flag3=flag3, flag4=flag4)
            if call.Done():
                pass
...
def t290110_x4(flag3=290, flag4=0):
    ...
    if GetGenericDialogButtonResult() == 1:
        ...
        DebugEvent('OK')
        """State 4"""
        assert t290110_x6(flag3=flag3, flag4=flag4, z5=0)
