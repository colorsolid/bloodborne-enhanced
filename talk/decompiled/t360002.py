...
def t360002_0():
    """State 0,1"""
    t360002_x1(flag1=6000, flag2=6001, actionbutton1=6100, actionbutton2=6101, actionbutton3=6103, flag3=360, flag4=2, action1=10010715)
    Quit()
...
def t360002_x0():
    """State 0,1"""
    SetEventState(10008500+67, 0)
    assert t360002_x7(z1=99999, z2=99999, z3=99999, z4=99999)
    """State 2"""
    return 0

def t360002_x1(flag1=6000, flag2=6001, actionbutton1=6100, actionbutton2=6101, actionbutton3=6103, flag3=360, flag4=2, action1=10010715):
    """State 0"""
    while True:
        """State 2"""
        DebugEvent('Beacon warp chair non-multi medium')
        call = t360002_x3(actionbutton1=actionbutton1, actionbutton2=actionbutton2, actionbutton3=actionbutton3, flag3=flag3, flag4=flag4,
                          action1=action1)
        if IsMultiplayerInProgress() == 1:
            """State 1"""
            DebugEvent('Beacon warp chair multi medium')
            call = t360002_x2(actionbutton1=actionbutton1, flag3=flag3, flag4=flag4, action1=action1)
...
def t360002_x2(actionbutton1=6100, flag3=360, flag4=2, action1=10010715):
    """State 0,3"""
    ForceCloseMenu()
    while True:
        """State 2"""
        if GetEventStatus(10007810 + flag3 * 10000 + flag4 * 20) == 1:
            ...
            SetTalkTime(0.33)
            """State 5"""
            call = t360002_x8(flag3=flag3, flag4=flag4, action1=action1)
            if call.Done():
                pass
...
def t360002_x3(actionbutton1=6100, actionbutton2=6101, actionbutton3=6103, flag3=360, flag4=2, action1=10010715):
    """State 0"""
    while True:
        """State 2"""
        Label('L0')
        ...
        if not GetEventStatus(10007810 + flag3 * 10000 + flag4 * 20):
            ...
            if flag3 * 10 + flag4 == 2802 and GetEventStatus(9802) == 1 and GetEventStatus(12100968) == 1:
                ...
                if GetEventStatus(12100972) == 1: # lamp mods disabled
                    ...
                    ClearPlayerDamageInfo()
                    SetTalkTime(0.33)
                    call = t360002_x4(flag3=360, flag4=2, action1=10010715)
                    if call.Done():
                        pass
                    elif GetDistanceToPlayer() > 3 or HasPlayerBeenAttacked() == 1:
                        """State 5"""
                    ...
                    ClearPlayerDamageInfo()
                    SetTalkTime(0.33)
                    call = t360002_x60(action1=action1)
                    if call.Done():
                        pass
                    elif GetDistanceToPlayer() > 3 or HasPlayerBeenAttacked() == 1:
                        assert t360002_x0()
...
def t360002_x4(flag3=360, flag4=2, action1=10010715):
    """State 0,5"""
    if not GetEventStatus(flag3 * 10 + 70000000 + flag4 * 1) or GetEventStatus(12100868) == 1:
        ...
        if GetGenericDialogButtonResult() == 1:
            ...
            DebugEvent('OK')
            """State 6"""
            call = t360002_x6(flag3=flag3, flag4=flag4, z5=0)
            if call.Get() == 1:
                pass
...
def t360002_x6(flag3=360, flag4=2, z5=0):
    """State 0,1"""
    SetEventState(flag3 * 10000 + 70000100 + flag4 * 1, 1)
    """State 2"""
    return 0

def t360002_x7(z1=99999, z2=99999, z3=99999, z4=99999):
    """State 0,1"""
...
def t360002_x8(flag3=360, flag4=2, action1=10010715):
    """State 0,2"""
    if not GetEventStatus(flag3 * 10 + 70000000 + flag4 * 1) or GetEventStatus(12100868) == 1:
        """State 3"""
...
# top level
def t360002_x60(action1=_):
    """State 0,6"""
    if not GetEventStatus(360 * 10 + 70000000 + 2 * 1) or GetEventStatus(12100868) == 1:
        if GetEventStatus(12100858) and GetEventStatus(12100861):
            SetEventState(12100761, 1)
            SetEventState(10008500+67, 1)
        else:
            pass
        while True:
            """State 1"""
            ...
            if GetEventStatus(12100961) or GetEventStatus(12100761):
                ...
                if (
                    ...
                    and (
                        GetEventStatus(12110000 + 360 * 10 + 2 * 2) == 0 
                        or GetEventStatus(12110000 + 360 * 10 + 2 * 2 + 1) == 0
                    )
                ):
            ...
            # boss rematch (distorted)
                ...
                call = t360002_x59(flag=13601800+14)
                if call.Get() == 1:
                    ForceCloseGenericDialog()
                    pass
                elif call.Done():
...
def t360002_x50():
    ...
    while True:
        ...
        # reawaken
            ...
            """State 15"""
            call = t360002_x40(flag3=1430, flag4=43, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 16"""
...
# warp to lamp
def t360002_x20(flag2=_, flag3=_, action1=_):
    """State 0,3"""
    DebugEvent('Flag judgment')
    if GetEventStatus(12100968) and flag2 * 10 + flag3 == 14303: # gascoigne
        if not GetEventStatus(70002413):
            ...
            assert not IsGenericDialogOpen()
            return 1
    elif GetEventStatus(12100968) and flag2 * 10 + flag3 == 14305: # amelia
        if not GetEventStatus(70002401):
            ...
            assert not IsGenericDialogOpen()
            return 1
    elif GetEventStatus(12100968) and flag2 * 10 + flag3 == 14321: # gaol
...
# reawaken
def t360002_x40(flag3=_, flag4=_, action1=10010715):
    """State 0,5"""
    if not GetEventStatus(flag3 * 10 + 70000000 + flag4 * 1):
        ...
        if GetGenericDialogButtonResult() == 1:
            ...
            DebugEvent('OK')
            """State 6"""
            call = t360002_x20(flag2=flag3, flag3=flag4, action1=10010715)
            if call.Get() == 1:
                pass
        elif not IsGenericDialogOpen():
            """State 2"""
...
def t360002_x51():
    ...
    while True:
        ...
        if not GetTalkListEntryResult() or not CheckSpecificPersonMenuIsOpen(100, 0):
            ...
            """State 7"""
            call = t360002_x20(flag2=1430, flag3=0, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 8"""
            ...
            """State 9"""
            call = t360002_x20(flag2=1430, flag3=1, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 10"""
            ...
            """State 11"""
            call = t360002_x20(flag2=1430, flag3=2, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 12"""
            ...
            """State 13"""
            call = t360002_x20(flag2=1430, flag3=3, action1=10010722)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 14"""
            ...
            """State 15"""
            call = t360002_x20(flag2=1430, flag3=4, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 16"""
            ...
            """State 17"""
            call = t360002_x20(flag2=1430, flag3=5, action1=10010723)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 18"""
            ...
            """State 19"""
            call = t360002_x20(flag2=1430, flag3=6, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 20"""
            ...
            """State 21"""
            call = t360002_x20(flag2=1430, flag3=7, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 22"""
            ...
            """State 23"""
            call = t360002_x20(flag2=1430, flag3=8, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 24"""
            ...
            """State 25"""
            call = t360002_x20(flag2=1430, flag3=9, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 26"""
            ...
            """State 27"""
            call = t360002_x20(flag2=1430, flag3=10, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 28"""
            ...
            """State 29"""
            call = t360002_x20(flag2=1430, flag3=11, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 30"""
...
def t360002_x52():
    ...
    while True:
        ...
        if not GetTalkListEntryResult() or not CheckSpecificPersonMenuIsOpen(100, 0):
            ...
            """State 7"""
            call = t360002_x20(flag2=1430, flag3=12, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 8"""
            ...
            """State 9"""
            call = t360002_x20(flag2=1430, flag3=13, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 10"""
            ...
            """State 11"""
            call = t360002_x20(flag2=1430, flag3=14, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 12"""
            ...
            """State 13"""
            call = t360002_x20(flag2=1430, flag3=15, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 14"""
            ...
            """State 15"""
            call = t360002_x20(flag2=1430, flag3=16, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 16"""
            ...
            """State 17"""
            call = t360002_x20(flag2=1430, flag3=17, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 18"""
...
def t360002_x53():
    ...
    while True:
        ...
        if not GetTalkListEntryResult() or not CheckSpecificPersonMenuIsOpen(100, 0):
            ...
            """State 7"""
            call = t360002_x20(flag2=1430, flag3=18, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 8"""
            ...
            """State 9"""
            call = t360002_x20(flag2=1430, flag3=19, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 10"""
            ...
            """State 11"""
            call = t360002_x20(flag2=1430, flag3=20, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 12"""
            ...
            """State 13"""
            call = t360002_x20(flag2=1430, flag3=21, action1=10010725)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 14"""
            ...
            """State 15"""
            call = t360002_x20(flag2=1430, flag3=22, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 16"""
            ...
            """State 17"""
            call = t360002_x20(flag2=1430, flag3=23, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 18"""
            ...
            """State 19"""
            call = t360002_x20(flag2=1430, flag3=24, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 20"""
            ...
            """State 21"""
            call = t360002_x20(flag2=1430, flag3=25, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 22"""
...
def t360002_x54():
    ...
    while True:
        ...
        if not GetTalkListEntryResult() or not CheckSpecificPersonMenuIsOpen(100, 0):
            ...
            """State 7"""
            call = t360002_x20(flag2=1430, flag3=26, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 8"""
            ...
            """State 9"""
            call = t360002_x20(flag2=1430, flag3=27, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 10"""
            ...
            """State 11"""
            call = t360002_x20(flag2=1430, flag3=28, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 12"""
            ...
            """State 13"""
            call = t360002_x20(flag2=1430, flag3=29, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 14"""
            ...
            """State 15"""
            call = t360002_x20(flag2=1430, flag3=30, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 16"""
            ...
            """State 17"""
            call = t360002_x20(flag2=1430, flag3=31, action1=10010715)
            if call.Done():
                """State 18"""
                return 0
            elif call.Get() == 1:
            ...
            """State 19"""
            call = t360002_x20(flag2=1430, flag3=32, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 20"""
            ...
            """State 21"""
            call = t360002_x20(flag2=1430, flag3=33, action1=10010715)
            if call.Done():
                """State 22"""
                return 0
            elif call.Get() == 1:
...
def t360002_x55():
    ...
    while True:
        ...
        if not GetTalkListEntryResult() or not CheckSpecificPersonMenuIsOpen(100, 0):
            ...
            """State 7"""
            call = t360002_x20(flag2=1430, flag3=34, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 8"""
            ...
            """State 9"""
            call = t360002_x20(flag2=1430, flag3=35, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 10"""
            ...
            """State 11"""
            call = t360002_x20(flag2=1430, flag3=36, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 12"""
            ...
            """State 13"""
            call = t360002_x20(flag2=1430, flag3=37, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 14"""
            ...
            """State 15"""
            call = t360002_x20(flag2=1430, flag3=38, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 16"""
            ...
            """State 17"""
            call = t360002_x20(flag2=1430, flag3=39, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 18"""
            ...
            """State 19"""
            assert t360002_x20(flag2=1430, flag3=40, action1=10010715)
            """State 20"""
            return 0
        elif GetTalkListEntryResult() == 16:
            """State 21"""
            call = t360002_x20(flag2=1430, flag3=41, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 22"""
            ...
            """State 23"""
            call = t360002_x20(flag2=1430, flag3=42, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 24"""
            ...
            """State 25"""
            call = t360002_x20(flag2=1430, flag3=43, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 26"""
...
def t360002_x115():
    ...
    while True:
        ...
        # first alter
            ...
            """State 5"""
            call = t360002_x135(flag1=72100433, flag2=1, actionbutton1=6116, action1=10011120, action2=10011130)
            if call.Get() == 1:
        ...
        # second alter
            ...
            """State 7"""
            call = t360002_x135(flag1=72100434, flag2=2, actionbutton1=6117, action1=10011120, action2=10011130)
            if call.Get() == 1:
                SetEventState(10001510, 1)
                SetEventState(10008500+67, 0)
                ForceCloseMenu()
        ...
        # third alter
            ...
            """State 9"""
            call = t360002_x135(flag1=72100435, flag2=3, actionbutton1=6118, action1=10011120, action2=10011130)
            if call.Get() == 1:
                SetEventState(10001510, 1)
                SetEventState(10008500+67, 0)
                ForceCloseMenu()
        ...
        # fourth alter
            ...
            """State 11"""
            call = t360002_x135(flag1=72100436, flag2=4, actionbutton1=6119, action1=10011120, action2=10011130)
            if call.Get() == 1:
                SetEventState(10001510, 1)
                SetEventState(10008500+67, 0)
                ForceCloseMenu()
        ...
        # fifth alter
            ...
            """State 13"""
            call = t360002_x135(flag1=72100437, flag2=5, actionbutton1=6120, action1=10011120, action2=10011130)
            if call.Get() == 1:
                SetEventState(10001510, 1)
                SetEventState(10008500+67, 0)
                ForceCloseMenu()
        ...
        # final alter
            ...
            """State 15"""
            call = t360002_x135(flag1=72100438, flag2=6, actionbutton1=6121, action1=10011120, action2=10011130)
            if call.Get() == 1:
                SetEventState(10001510, 1)
                SetEventState(10008500+67, 0)
                ForceCloseMenu()
...
def t360002_x130():
    """State 0,1"""
    SetEventState(10008500+67, 0)
    assert t360002_x131(z2=99999, z3=99999, z4=99999, z5=99999)
    """State 2"""
    return 0

def t360002_x131(z2=99999, z3=99999, z4=99999, z5=99999):
    """State 0,1"""
    DebugEvent('会話判定')
    if not CheckSpecificPersonTalkHasEnded(0):
        """State 7"""
...
def t360002_x132(actionbutton1=6116, flag3=6000, flag4=6001, flag5=6001, flag6=6001, flag7=6001, flag8=6001,
               flag9=6001):
    """State 0"""
    while True:
        """State 1"""
...
def t360002_x133(flag1=72100421, flag2=1, actionbutton1=6116, action1=10011120, action2=10011130):
    """State 0"""
    while True:
        """State 2"""
        call = t360002_x135(flag1=flag1, flag2=flag2, actionbutton1=actionbutton1, action1=action1, action2=action2)
...
def t360002_x135(flag1=72100421, flag2=1, actionbutton1=6116, action1=10011120, action2=10011130):
    """State 0"""
    while True:
        """State 1"""
        Label('L0')
        ...
        def ExitPause():
            c1_73(1)
        # assert (t360002_x132(actionbutton1=actionbutton1, flag3=6000, flag4=6001, flag5=6001, flag6=6001,
        ...
        c1_73(1)
        """State 8"""
        call = t360002_x136(flag1=flag1, action1=action1, action2=action2, flag2=flag2)
        def WhilePaused():
            SetTalkTime(0.33)
        if call.Get() == 1:
            """State 12"""
...
def t360002_x136(flag1=72100421, action1=10011120, action2=10011130, flag2=1):
    """State 0,19"""
    DebugEvent('unknow')
            ...
            if (ComparePlayerInventoryNumber(3, 6522, 0, 0, 0) == 1 and ComparePlayerInventoryNumber(3,
                ...
                while True:
                    ...
                    if GetTalkListEntryResult() == 1:
                        ...
                        DebugEvent('ダンジョン_1F')
                        """State 39"""
                        assert t360002_x137(flag1=flag1, z1=72100300)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 2:
                        """State 10"""
                        DebugEvent('ダンジョン_2F')
                        """State 40"""
                        assert t360002_x137(flag1=flag1, z1=72100301)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 3:
                        """State 4"""
                        DebugEvent('ダンジョン_3F')
                        """State 41"""
                        assert t360002_x137(flag1=flag1, z1=72100302)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 4:
                        """State 7"""
                        DebugEvent('ダンジョン_4F')
                        """State 42"""
                        assert t360002_x137(flag1=flag1, z1=72100303)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 5:
                        """State 11"""
                        DebugEvent('ダンジョン_5F')
                        """State 43"""
                        assert t360002_x137(flag1=flag1, z1=72100304)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 6:
                        """State 8"""
                        DebugEvent('ダンジョン_6F')
                        """State 44"""
                        assert t360002_x137(flag1=flag1, z1=72100305)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 7:
                        """State 9"""
                        DebugEvent('ダンジョン_7F')
                        """State 45"""
                        assert t360002_x137(flag1=flag1, z1=72100306)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 8:
                        """State 12"""
                        DebugEvent('ダンジョン_8F')
                        """State 46"""
                        assert t360002_x137(flag1=flag1, z1=72100307)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 9:
                        """State 13"""
                        DebugEvent('ダンジョン_9F')
                        """State 47"""
                        assert t360002_x137(flag1=flag1, z1=72100308)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 10:
                        """State 14"""
                        DebugEvent('ダンジョン_10F')
                        """State 48"""
                        assert t360002_x137(flag1=flag1, z1=72100309)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 11:
                        """State 15"""
                        DebugEvent('To the warp chair in operation')
                        """State 49"""
                        assert t360002_x138(flag1=flag1)
                        Goto('L1')
...
def t360002_x137(flag1=72100421, z1=_):
    """State 0,1"""
...
def t360002_x138(flag1=72100421):
    """State 0,1"""
