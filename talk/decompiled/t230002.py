...
def t230002_0():
    """State 0,1"""
    t230002_x1(flag1=6000, flag2=6001, actionbutton1=6100, actionbutton2=6101, flag3=230, flag4=2, action1=10010715)
    Quit()
...
def t230002_x1(flag1=6000, flag2=6001, actionbutton1=6100, actionbutton2=6101, flag3=230, flag4=2, action1=10010715):
    """State 0"""
    while True:
        """State 2"""
        DebugEvent('地上子ワープ椅子_非マルチ中')
        call = t230002_x3(actionbutton1=actionbutton1, actionbutton2=actionbutton2, flag3=flag3, flag4=flag4,
                          action1=action1)
...
def t230002_x3(actionbutton1=6100, actionbutton2=6101, flag3=230, flag4=2, action1=10010715):
    """State 0"""
    while True:
        """State 2"""
        Label('L0')
        ...
        if not GetEventStatus(10007810 + flag3 * 10000 + flag4 * 20):
            ...
            SetTalkTime(0.33)
            """State 6"""
            call = t230002_x4(flag3=flag3, flag4=flag4, action1=action1)
            if call.Done():
                pass
            elif GetDistanceToPlayer() > 3 or HasPlayerBeenAttacked() == 1:
                """State 5"""
...
def t230002_x4(flag3=230, flag4=2, action1=10010715):
    ...
    if not GetEventStatus(flag3 * 10 + 70000000 + flag4 * 1):
        ...
        if GetGenericDialogButtonResult() == 1:
            ...
            DebugEvent('OK')
            """State 6"""
            assert t230002_x6(flag3=flag3, flag4=flag4, z5=0)
