...
def t350029_x0():
    """State 0,1"""
    assert t350029_x7(z1=99999, z2=99999, z3=99999, z4=99999)
    """State 2"""
    return 0
...
def t350029_x6(flag3=241, flag4=0, z5=0):
    """State 0,1"""
    SetEventState(flag3 * 10000 + 70000100 + flag4 * 1, 1)
    """State 2"""
    return 0

def t350029_x7(z1=99999, z2=99999, z3=99999, z4=99999):
    """State 0,1"""
...
def t350029_x50():
    ...
    while True:
        ...
        # hunter's dream
            ...
            """State 17"""
            call = t350029_x4()
            # call = t350029_x4(flag3=241, flag4=0, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 18"""
...
def t350029_x115():
    ...
    while True:
        ...
        # first altar
            ...
            """State 5"""
            call = t350029_x135(flag1=72100475, flag2=1, actionbutton1=6116, action1=10011120, action2=10011130)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                """State 6"""
        ...
        # second altar
            ...
            """State 7"""
            call = t350029_x135(flag1=72100476, flag2=2, actionbutton1=6117, action1=10011120, action2=10011130)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                """State 8"""
        ...
        # third altar
            ...
            """State 9"""
            call = t350029_x135(flag1=72100477, flag2=3, actionbutton1=6118, action1=10011120, action2=10011130)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                """State 10"""
        ...
        # fourth altar
            ...
            """State 11"""
            call = t350029_x135(flag1=72100478, flag2=4, actionbutton1=6119, action1=10011120, action2=10011130)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                """State 12"""
        ...
        # fifth altar
            ...
            """State 13"""
            call = t350029_x135(flag1=72100479, flag2=5, actionbutton1=6120, action1=10011120, action2=10011130)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                """State 14"""
        ...
        # final altar
            ...
            """State 15"""
            call = t350029_x135(flag1=72100480, flag2=6, actionbutton1=6121, action1=10011120, action2=10011130)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                """State 16"""
...
def t350029_x130():
    """State 0,1"""
    assert t350029_x131(z2=99999, z3=99999, z4=99999, z5=99999)
    """State 2"""
    return 0

def t350029_x131(z2=99999, z3=99999, z4=99999, z5=99999):
    """State 0,1"""
    DebugEvent('会話判定')
    if not CheckSpecificPersonTalkHasEnded(0):
        """State 7"""
...
def t350029_x132(actionbutton1=6116, flag3=6000, flag4=6001, flag5=6001, flag6=6001, flag7=6001, flag8=6001,
               flag9=6001):
    """State 0"""
    while True:
        """State 1"""
...
def t350029_x135(flag1=72100421, flag2=1, actionbutton1=6116, action1=10011120, action2=10011130):
    """State 0"""
    while True:
        """State 1"""
        Label('L0')
        ...
        def ExitPause():
            c1_73(1)
        # assert (t350029_x132(actionbutton1=actionbutton1, flag3=6000, flag4=6001, flag5=6001, flag6=6001,
        ...
        c1_73(1)
        """State 8"""
        call = t350029_x136(flag1=flag1, action1=action1, action2=action2, flag2=flag2)
        def WhilePaused():
            SetTalkTime(0.33)
        if call.Get() == 1:
            """State 12"""
...
def t350029_x136(flag1=72100421, action1=10011120, action2=10011130, flag2=1):
    """State 0,19"""
    DebugEvent('unknow')
            ...
            if (ComparePlayerInventoryNumber(3, 6522, 0, 0, 0) == 1 and ComparePlayerInventoryNumber(3,
                ...
                while True:
                    ...
                    if GetTalkListEntryResult() == 1:
                        ...
                        DebugEvent('ダンジョン_1F')
                        """State 39"""
                        assert t350029_x137(flag1=flag1)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 2:
                        """State 10"""
                        DebugEvent('ダンジョン_2F')
                        ...
                        """State 48"""
                        assert t350029_x137(flag1=flag1, z1=72100309)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 11:
                        """State 15"""
                        DebugEvent('To the warp chair in operation')
                        """State 49"""
                        assert t350029_x138(flag1=flag1)
                        Goto('L1')
...
def t350029_x137(flag1=72100421, flag2=999, flag3=999, flag4=999, z1=1):
    """State 0,1"""
    SetEventState(flag1, 1)
    SetEventState(flag2, 1)
    SetEventState(flag3, 1)
...
def t350029_x138(flag1=72100421):
    """State 0,1"""
    ...
    if GetEventStatus(12907991) == 1:
        ...
        DebugEvent('ワープ椅子08')
        """State 20"""
        assert t350029_x137(flag1=flag1, z1=72100308)
    elif GetEventStatus(12907951) == 1:
        """State 9"""
        DebugEvent('ワープ椅子07')
        """State 19"""
        assert t350029_x137(flag1=flag1, z1=72100307)
    elif GetEventStatus(12907911) == 1:
        """State 5"""
        DebugEvent('ワープ椅子05')
        """State 17"""
        assert t350029_x137(flag1=flag1, z1=72100305)
    elif GetEventStatus(12907931) == 1:
        """State 6"""
        DebugEvent('ワープ椅子06')
        """State 18"""
        assert t350029_x137(flag1=flag1, z1=72100306)
    elif GetEventStatus(12907831) == 1:
        """State 7"""
        DebugEvent('ワープ椅子01')
        """State 13"""
        assert t350029_x137(flag1=flag1, z1=72100301)
    elif GetEventStatus(12907891) == 1:
        """State 8"""
        DebugEvent('ワープ椅子04')
        """State 16"""
        assert t350029_x137(flag1=flag1, z1=72100304)
    elif GetEventStatus(12907871) == 1:
        """State 4"""
        DebugEvent('ワープ椅子03')
        """State 15"""
        assert t350029_x137(flag1=flag1, z1=72100303)
    elif GetEventStatus(12907851) == 1:
        """State 2"""
        DebugEvent('ワープ椅子02')
        """State 14"""
        assert t350029_x137(flag1=flag1, z1=72100302)
    else:
        """State 3"""
        DebugEvent('ワープ椅子00')
        """State 12"""
        assert t350029_x137(flag1=flag1, z1=72100300)
    """State 22"""
    return 0
...
def t350029_x103():
    while True:
        ...
        if not GetTalkListEntryResult() or not IsTalkExclusiveMenuOpen():
            ...
            call = t350029_x104(d1=200211, e1=12308040)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                pass
        elif GetTalkListEntryResult() == 2: # lone survivor
            call = t350029_x104(d1=200212, e1=12308041)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                pass
        elif GetTalkListEntryResult() == 3: # troubled childhood
            call = t350029_x104(d1=200213, e1=12308042)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                pass
        elif GetTalkListEntryResult() == 4: # violent past
            call = t350029_x104(d1=200214, e1=12308043)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                pass
        elif GetTalkListEntryResult() == 5: # professional
            call = t350029_x104(d1=200215, e1=12308044)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                pass
        elif GetTalkListEntryResult() == 6: # military veteran
            call = t350029_x104(d1=200216, e1=12308045)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                pass
        elif GetTalkListEntryResult() == 7: # noble scion
            call = t350029_x104(d1=200217, e1=12308046)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                pass
        elif GetTalkListEntryResult() == 8: # cruel fate
            call = t350029_x104(d1=200218, e1=12308047)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                pass
        elif GetTalkListEntryResult() == 9: # waste of skin
            call = t350029_x104(d1=200219, e1=12308048)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                pass
