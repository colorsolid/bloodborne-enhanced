...
def t241029_x3():
    ...
    while True:
        ...
        if GetEventStatus(12421900) == 1 and GetEventStatus(8681) == 1: # portable lamp
            ...
            ClearPlayerDamageInfo()
            SetTalkTime(0.33)
            if GetEventStatus(8631) == 0 and GetEventStatus(8641) == 0 and GetEventStatus(8632) == 0 and GetEventStatus(8642) == 0:
...
def t241029_x41():
    while True:
        ClearTalkListData()
        AddTalkListData(2, 10010575, 8641) # summon gascoigne
        AddTalkListData(4, 10010576, 8642) # summon alfred
        AddTalkListData(3, 10010591, 8631) # dismiss gascoigne
        AddTalkListData(5, 10010592, 8632) # dismiss alfred
...
def t241029_x21(flag1=999, flag2=999, flag3=999, flag4=999, flag5=999):
...
def t241029_x51():
    ...
    while True:
        ...
        if not GetTalkListEntryResult() or not CheckSpecificPersonMenuIsOpen(100, 0):
            ...
            """State 11"""
            call = t241029_x21(flag1=8608, flag2=8609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 12"""
            ...
            """State 15"""
            call = t241029_x21(flag1=8607, flag2=8609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 16"""
            ...
            """State 17"""
            call = t241029_x21(flag1=8607, flag2=8608)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 18"""
            ...
            """State 19"""
            call = t241029_x21(flag1=8607, flag2=8608, flag3=8609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 20"""
            ...
            """State 23"""
            call = t241029_x21(flag1=8606, flag2=8609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 24"""
            ...
            """State 25"""
            call = t241029_x21(flag1=8606, flag2=8608)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 26"""
            ...
            """State 27"""
            call = t241029_x21(flag1=8606, flag2=8608, flag3=8609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 28"""
            ...
            """State 29"""
            call = t241029_x21(flag1=8606, flag2=8607)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 30"""
...
def t241029_x52():
    ...
    while True:
        ...
        if not GetTalkListEntryResult() or not CheckSpecificPersonMenuIsOpen(100, 0):
            ...
            """State 7"""
            call = t241029_x21(flag1=8606, flag2=8607, flag3=8609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 8"""
            ...
            """State 9"""
            call = t241029_x21(flag1=8606, flag2=8607, flag3=8608)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 10"""
            ...
            """State 11"""
            call = t241029_x21(flag1=8606, flag2=8607, flag3=8608, flag4=8609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 12"""
            ...
            """State 15"""
            call = t241029_x21(flag1=8605, flag2=8609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 16"""
            ...
            """State 17"""
            call = t241029_x21(flag1=8605, flag2=8608)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 18"""
...
def t241029_x53():
    ...
    while True:
        ...
        if not GetTalkListEntryResult() or not CheckSpecificPersonMenuIsOpen(100, 0):
            ...
            """State 7"""
            call = t241029_x21(flag1=8605, flag2=8608, flag3=8609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 8"""
            ...
            """State 9"""
            call = t241029_x21(flag1=8605, flag2=8607)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 10"""
            ...
            """State 11"""
            call = t241029_x21(flag1=8605, flag2=8607, flag3=8609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 12"""
            ...
            """State 13"""
            call = t241029_x21(flag1=8605, flag2=8607, flag3=8608)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 14"""
            ...
            """State 15"""
            call = t241029_x21(flag1=8605, flag2=8607, flag3=8608, flag4=8609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 16"""
            ...
            """State 17"""
            call = t241029_x21(flag1=8605, flag2=8606)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 18"""
            ...
            """State 19"""
            call = t241029_x21(flag1=8605, flag2=8606, flag3=8609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 20"""
            ...
            """State 21"""
            call = t241029_x21(flag1=8605, flag2=8606, flag3=8608)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 22"""
...
def t241029_x54():
    ...
    while True:
        ...
        if not GetTalkListEntryResult() or not CheckSpecificPersonMenuIsOpen(100, 0):
            ...
            """State 7"""
            call = t241029_x21(flag1=8605, flag2=8606, flag3=8608, flag4=8609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 8"""
            ...
            """State 9"""
            call = t241029_x21(flag1=8605, flag2=8606, flag3=8607)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 10"""
            ...
            """State 11"""
            call = t241029_x21(flag1=8605, flag2=8606, flag3=8607, flag4=8609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 12"""
            ...
            """State 13"""
            call = t241029_x21(flag1=8605, flag2=8606, flag3=8607, flag4=8608)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 14"""
            ...
            """State 15"""
            call = t241029_x21(flag1=8605, flag2=8606, flag3=8607, flag4=8608, flag5=8609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 16"""
            ...
            """State 19"""
            call = t241029_x21(flag1=8604, flag2=8609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 20"""
            ...
            """State 21"""
            call = t241029_x21(flag1=8604, flag2=8608)
            if call.Done():
                """State 22"""
                return 0
            elif call.Get() == 1:
...
def t241029_x55():
    ...
    while True:
        ...
        if not GetTalkListEntryResult() or not CheckSpecificPersonMenuIsOpen(100, 0):
            ...
            """State 7"""
            call = t241029_x21(flag1=8604, flag2=8608, flag3=8609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 8"""
            ...
            """State 9"""
            call = t241029_x21(flag1=8604, flag2=8607)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 10"""
            ...
            """State 11"""
            call = t241029_x21(flag1=8604, flag2=8607, flag3=8609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 12"""
            ...
            """State 13"""
            call = t241029_x21(flag1=8604, flag2=8607, flag3=8608)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 14"""
            ...
            """State 15"""
            call = t241029_x21(flag1=8604, flag2=8607, flag3=8608, flag4=8609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 16"""
            ...
            """State 17"""
            call = t241029_x21(flag1=8604, flag2=8606)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 18"""
            ...
            """State 19"""
            assert t241029_x21(flag1=8604, flag2=8606, flag3=8609)
            """State 20"""
            return 0
        elif GetTalkListEntryResult() == 16:
            """State 21"""
            call = t241029_x21(flag1=8604, flag2=8606, flag3=8608)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 22"""
            ...
            """State 23"""
            call = t241029_x21(flag1=8604, flag2=8606, flag3=8608, flag4=8609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 24"""
            ...
            """State 25"""
            call = t241029_x21(flag1=8604, flag2=8606, flag3=8607)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 26"""
            ...
            if (ComparePlayerInventoryNumber(3, 6522, 0, 0, 0) == 1 and ComparePlayerInventoryNumber(3,
                ...
                while True:
                    ...
                    if GetTalkListEntryResult() == 1:
                        ...
                        DebugEvent('ダンジョン_2F')
                        """State 40"""
                        assert t241029_x137(flag1=flag1, flag2=8614)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 3:
                        """State 4"""
                        DebugEvent('ダンジョン_3F')
                        """State 41"""
                        assert t241029_x137(flag1=flag1, flag2=8613)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 4:
                        """State 7"""
                        DebugEvent('ダンジョン_4F')
                        """State 42"""
                        assert t241029_x137(flag1=flag1, flag2=8613, flag3=8614)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 5:
                        """State 11"""
                        DebugEvent('ダンジョン_5F')
                        """State 43"""
                        assert t241029_x137(flag1=flag1, flag2=8612)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 6:
                        """State 8"""
                        DebugEvent('ダンジョン_6F')
                        """State 44"""
                        assert t241029_x137(flag1=flag1, flag2=8612, flag3=8614)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 7:
                        """State 9"""
                        DebugEvent('ダンジョン_7F')
                        """State 45"""
                        assert t241029_x137(flag1=flag1, flag2=8612, flag3=8613)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 8:
                        """State 12"""
                        DebugEvent('ダンジョン_8F')
                        """State 46"""
                        assert t241029_x137(flag1=flag1, flag2=8612, flag3=8613, flag4=8614)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 9:
                        """State 13"""
                        DebugEvent('ダンジョン_9F')
                        """State 47"""
                        assert t241029_x137(flag1=flag1, flag2=8611)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 10:
                        """State 14"""
