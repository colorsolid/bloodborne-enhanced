...
def t242029_x0():
    """State 0,1"""
    assert t242029_x7(z1=99999, z2=99999, z3=99999, z4=99999)
    """State 2"""
    return 0
...
def t242029_x3():
    ...
    while True:
        ...
        if GetEventStatus(12421900) == 1 and GetEventStatus(10008681) == 1: # portable lamp
            ...
            ClearPlayerDamageInfo()
            SetTalkTime(0.33)
            if GetEventStatus(10008631) == 0 and GetEventStatus(10008641) == 0:
...
def t242029_x6(flag3=241, flag4=0, z5=0):
    """State 0,1"""
    SetEventState(flag3 * 10000 + 70000100 + flag4 * 1, 1)
    """State 2"""
    return 0

def t242029_x7(z1=99999, z2=99999, z3=99999, z4=99999):
    """State 0,1"""
...
def t242029_x41():
    while True:
        ClearTalkListData()
        AddTalkListData(2, 10010566, 10008641) # summon damien
        AddTalkListData(3, 10010582, 10008631) # dismiss damien
        ...
        if not GetTalkListEntryResult() or not IsTalkExclusiveMenuOpen():
            ...
            return 1
        elif GetTalkListEntryResult() == 2: # summon damien
            SetEventState(10008631, 1)
            return 1
        elif GetTalkListEntryResult() == 3: # dismiss damien
...
def t242029_x50():
    ...
    while True:
        ...
        # hunter's dream
            ...
            """State 17"""
            call = t242029_x4()
            # call = t242029_x4(flag3=241, flag4=0, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 18"""
...
def t242029_x21(flag1=10000999, flag2=10000999, flag3=10000999, flag4=10000999, flag5=10000999):
...
def t242029_x51():
    ...
    while True:
        ...
        if not GetTalkListEntryResult() or not CheckSpecificPersonMenuIsOpen(100, 0):
            ...
            """State 7"""
            call = t242029_x21(flag1=10008609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 8"""
            ...
            """State 9"""
            call = t242029_x21(flag1=10008608)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 10"""
            ...
            """State 11"""
            call = t242029_x21(flag1=10008608, flag2=10008609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 12"""
            ...
            """State 13"""
            call = t242029_x21(flag1=10008607)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 14"""
            ...
            """State 15"""
            call = t242029_x21(flag1=10008607, flag2=10008609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 16"""
            ...
            """State 17"""
            call = t242029_x21(flag1=10008607, flag2=10008608)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 18"""
            ...
            """State 19"""
            call = t242029_x21(flag1=10008607, flag2=10008608, flag3=10008609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 20"""
            ...
            """State 21"""
            call = t242029_x21(flag1=10008606)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 22"""
            ...
            """State 23"""
            call = t242029_x21(flag1=10008606, flag2=10008609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 24"""
            ...
            """State 25"""
            call = t242029_x21(flag1=10008606, flag2=10008608)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 26"""
            ...
            """State 27"""
            call = t242029_x21(flag1=10008606, flag2=10008608, flag3=10008609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 28"""
            ...
            """State 29"""
            call = t242029_x21(flag1=10008606, flag2=10008607)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 30"""
...
def t242029_x52():
    ...
    while True:
        ...
        if not GetTalkListEntryResult() or not CheckSpecificPersonMenuIsOpen(100, 0):
            ...
            """State 7"""
            call = t242029_x21(flag1=10008606, flag2=10008607, flag3=10008609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 8"""
            ...
            """State 9"""
            call = t242029_x21(flag1=10008606, flag2=10008607, flag3=10008608)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 10"""
            ...
            """State 11"""
            call = t242029_x21(flag1=10008606, flag2=10008607, flag3=10008608, flag4=10008609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 12"""
            ...
            """State 13"""
            call = t242029_x21(flag1=10008605)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 14"""
            ...
            """State 15"""
            call = t242029_x21(flag1=10008605, flag2=10008609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 16"""
            ...
            """State 17"""
            call = t242029_x21(flag1=10008605, flag2=10008608)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 18"""
...
def t242029_x53():
    ...
    while True:
        ...
        if not GetTalkListEntryResult() or not CheckSpecificPersonMenuIsOpen(100, 0):
            ...
            """State 7"""
            call = t242029_x21(flag1=10008605, flag2=10008608, flag3=10008609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 8"""
            ...
            """State 9"""
            call = t242029_x21(flag1=10008605, flag2=10008607)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 10"""
            ...
            """State 11"""
            call = t242029_x21(flag1=10008605, flag2=10008607, flag3=10008609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 12"""
            ...
            """State 13"""
            call = t242029_x21(flag1=10008605, flag2=10008607, flag3=10008608)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 14"""
            ...
            """State 15"""
            call = t242029_x21(flag1=10008605, flag2=10008607, flag3=10008608, flag4=10008609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 16"""
            ...
            """State 17"""
            call = t242029_x21(flag1=10008605, flag2=10008606)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 18"""
            ...
            """State 19"""
            call = t242029_x21(flag1=10008605, flag2=10008606, flag3=10008609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 20"""
            ...
            """State 21"""
            call = t242029_x21(flag1=10008605, flag2=10008606, flag3=10008608)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 22"""
...
def t242029_x54():
    ...
    while True:
        ...
        if not GetTalkListEntryResult() or not CheckSpecificPersonMenuIsOpen(100, 0):
            ...
            """State 7"""
            call = t242029_x21(flag1=10008605, flag2=10008606, flag3=10008608, flag4=10008609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 8"""
            ...
            """State 9"""
            call = t242029_x21(flag1=10008605, flag2=10008606, flag3=10008607)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 10"""
            ...
            """State 11"""
            call = t242029_x21(flag1=10008605, flag2=10008606, flag3=10008607, flag4=10008609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 12"""
            ...
            """State 13"""
            call = t242029_x21(flag1=10008605, flag2=10008606, flag3=10008607, flag4=10008608)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 14"""
            ...
            """State 15"""
            call = t242029_x21(flag1=10008605, flag2=10008606, flag3=10008607, flag4=10008608, flag5=10008609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 16"""
            ...
            """State 17"""
            call = t242029_x21(flag1=10008604)
            if call.Done():
                """State 18"""
                return 0
            elif call.Get() == 1:
            ...
            """State 19"""
            call = t242029_x21(flag1=10008604, flag2=10008609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 20"""
            ...
            """State 21"""
            call = t242029_x21(flag1=10008604, flag2=10008608)
            if call.Done():
                """State 22"""
                return 0
            elif call.Get() == 1:
...
def t242029_x55():
    ...
    while True:
        ...
        if not GetTalkListEntryResult() or not CheckSpecificPersonMenuIsOpen(100, 0):
            ...
            """State 7"""
            call = t242029_x21(flag1=10008604, flag2=10008608, flag3=10008609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 8"""
            ...
            """State 9"""
            call = t242029_x21(flag1=10008604, flag2=10008607)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 10"""
            ...
            """State 11"""
            call = t242029_x21(flag1=10008604, flag2=10008607, flag3=10008609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 12"""
            ...
            """State 13"""
            call = t242029_x21(flag1=10008604, flag2=10008607, flag3=10008608)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 14"""
            ...
            """State 15"""
            call = t242029_x21(flag1=10008604, flag2=10008607, flag3=10008608, flag4=10008609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 16"""
            ...
            """State 17"""
            call = t242029_x21(flag1=10008604, flag2=10008606)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 18"""
            ...
            """State 19"""
            assert t242029_x21(flag1=10008604, flag2=10008606, flag3=10008609)
            """State 20"""
            return 0
        elif GetTalkListEntryResult() == 16:
            """State 21"""
            call = t242029_x21(flag1=10008604, flag2=10008606, flag3=10008608)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 22"""
            ...
            """State 23"""
            call = t242029_x21(flag1=10008604, flag2=10008606, flag3=10008608, flag4=10008609)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 24"""
            ...
            """State 25"""
            call = t242029_x21(flag1=10008604, flag2=10008606, flag3=10008607)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 26"""
...
def t242029_x115():
    ...
    while True:
        ...
        # first altar
            ...
            """State 5"""
            call = t242029_x135(flag1=72100475, flag2=1, actionbutton1=6116, action1=10011120, action2=10011130)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                """State 6"""
        ...
        # second altar
            ...
            """State 7"""
            call = t242029_x135(flag1=72100476, flag2=2, actionbutton1=6117, action1=10011120, action2=10011130)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                """State 8"""
        ...
        # third altar
            ...
            """State 9"""
            call = t242029_x135(flag1=72100477, flag2=3, actionbutton1=6118, action1=10011120, action2=10011130)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                """State 10"""
        ...
        # fourth altar
            ...
            """State 11"""
            call = t242029_x135(flag1=72100478, flag2=4, actionbutton1=6119, action1=10011120, action2=10011130)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                """State 12"""
        ...
        # fifth altar
            ...
            """State 13"""
            call = t242029_x135(flag1=72100479, flag2=5, actionbutton1=6120, action1=10011120, action2=10011130)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                """State 14"""
        ...
        # final altar
            ...
            """State 15"""
            call = t242029_x135(flag1=72100480, flag2=6, actionbutton1=6121, action1=10011120, action2=10011130)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                """State 16"""
...
def t242029_x130():
    """State 0,1"""
    assert t242029_x131(z2=99999, z3=99999, z4=99999, z5=99999)
    """State 2"""
    return 0

def t242029_x131(z2=99999, z3=99999, z4=99999, z5=99999):
    """State 0,1"""
    DebugEvent('会話判定')
    if not CheckSpecificPersonTalkHasEnded(0):
        """State 7"""
...
def t242029_x132(actionbutton1=6116, flag3=6000, flag4=6001, flag5=6001, flag6=6001, flag7=6001, flag8=6001,
               flag9=6001):
    """State 0"""
    while True:
        """State 1"""
...
def t242029_x135(flag1=72100421, flag2=1, actionbutton1=6116, action1=10011120, action2=10011130):
    """State 0"""
    while True:
        """State 1"""
        Label('L0')
        ...
        def ExitPause():
            c1_73(1)
        # assert (t242029_x132(actionbutton1=actionbutton1, flag3=6000, flag4=6001, flag5=6001, flag6=6001,
        ...
        c1_73(1)
        """State 8"""
        call = t242029_x136(flag1=flag1, action1=action1, action2=action2, flag2=flag2)
        def WhilePaused():
            SetTalkTime(0.33)
        if call.Get() == 1:
            """State 12"""
...
def t242029_x136(flag1=72100421, action1=10011120, action2=10011130, flag2=1):
    """State 0,19"""
    DebugEvent('unknow')
            ...
            if (ComparePlayerInventoryNumber(3, 6522, 0, 0, 0) == 1 and ComparePlayerInventoryNumber(3,
                ...
                while True:
                    ...
                    if GetTalkListEntryResult() == 1:
                        ...
                        DebugEvent('ダンジョン_1F')
                        """State 39"""
                        assert t242029_x137(flag1=flag1)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 2:
                        """State 10"""
                        DebugEvent('ダンジョン_2F')
                        """State 40"""
                        assert t242029_x137(flag1=flag1, flag2=10008614)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 3:
                        """State 4"""
                        DebugEvent('ダンジョン_3F')
                        """State 41"""
                        assert t242029_x137(flag1=flag1, flag2=10008613)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 4:
                        """State 7"""
                        DebugEvent('ダンジョン_4F')
                        """State 42"""
                        assert t242029_x137(flag1=flag1, flag2=10008613, flag3=10008614)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 5:
                        """State 11"""
                        DebugEvent('ダンジョン_5F')
                        """State 43"""
                        assert t242029_x137(flag1=flag1, flag2=10008612)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 6:
                        """State 8"""
                        DebugEvent('ダンジョン_6F')
                        """State 44"""
                        assert t242029_x137(flag1=flag1, flag2=10008612, flag3=10008614)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 7:
                        """State 9"""
                        DebugEvent('ダンジョン_7F')
                        """State 45"""
                        assert t242029_x137(flag1=flag1, flag2=10008612, flag3=10008613)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 8:
                        """State 12"""
                        DebugEvent('ダンジョン_8F')
                        """State 46"""
                        assert t242029_x137(flag1=flag1, flag2=10008612, flag3=10008613, flag4=10008614)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 9:
                        """State 13"""
                        DebugEvent('ダンジョン_9F')
                        """State 47"""
                        assert t242029_x137(flag1=flag1, flag2=10008611)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 10:
                        """State 14"""
                        DebugEvent('ダンジョン_10F')
                        """State 48"""
                        assert t242029_x137(flag1=flag1, z1=72100309)
                        Goto('L1')
                    elif GetTalkListEntryResult() == 11:
                        """State 15"""
                        DebugEvent('To the warp chair in operation')
                        """State 49"""
                        assert t242029_x138(flag1=flag1)
                        Goto('L1')
...
def t242029_x137(flag1=72100421, flag2=999, flag3=999, flag4=999, z1=1):
    """State 0,1"""
    SetEventState(flag1, 1)
    SetEventState(flag2, 1)
    SetEventState(flag3, 1)
...
def t242029_x138(flag1=72100421):
    """State 0,1"""
    ...
    if GetEventStatus(12907991) == 1:
        ...
        DebugEvent('ワープ椅子08')
        """State 20"""
        assert t242029_x137(flag1=flag1, z1=72100308)
    elif GetEventStatus(12907951) == 1:
        """State 9"""
        DebugEvent('ワープ椅子07')
        """State 19"""
        assert t242029_x137(flag1=flag1, z1=72100307)
    elif GetEventStatus(12907911) == 1:
        """State 5"""
        DebugEvent('ワープ椅子05')
        """State 17"""
        assert t242029_x137(flag1=flag1, z1=72100305)
    elif GetEventStatus(12907931) == 1:
        """State 6"""
        DebugEvent('ワープ椅子06')
        """State 18"""
        assert t242029_x137(flag1=flag1, z1=72100306)
    elif GetEventStatus(12907831) == 1:
        """State 7"""
        DebugEvent('ワープ椅子01')
        """State 13"""
        assert t242029_x137(flag1=flag1, z1=72100301)
    elif GetEventStatus(12907891) == 1:
        """State 8"""
        DebugEvent('ワープ椅子04')
        """State 16"""
        assert t242029_x137(flag1=flag1, z1=72100304)
    elif GetEventStatus(12907871) == 1:
        """State 4"""
        DebugEvent('ワープ椅子03')
        """State 15"""
        assert t242029_x137(flag1=flag1, z1=72100303)
    elif GetEventStatus(12907851) == 1:
        """State 2"""
        DebugEvent('ワープ椅子02')
        """State 14"""
        assert t242029_x137(flag1=flag1, z1=72100302)
    else:
        """State 3"""
        DebugEvent('ワープ椅子00')
        """State 12"""
        assert t242029_x137(flag1=flag1, z1=72100300)
    """State 22"""
    return 0
...
def t242029_x103():
    while True:
        ...
        if not GetTalkListEntryResult() or not IsTalkExclusiveMenuOpen():
            ...
            call = t242029_x104(d1=200211, e1=12308040)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                pass
        elif GetTalkListEntryResult() == 2: # lone survivor
            call = t242029_x104(d1=200212, e1=12308041)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                pass
        elif GetTalkListEntryResult() == 3: # troubled childhood
            call = t242029_x104(d1=200213, e1=12308042)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                pass
        elif GetTalkListEntryResult() == 4: # violent past
            call = t242029_x104(d1=200214, e1=12308043)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                pass
        elif GetTalkListEntryResult() == 5: # professional
            call = t242029_x104(d1=200215, e1=12308044)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                pass
        elif GetTalkListEntryResult() == 6: # military veteran
            call = t242029_x104(d1=200216, e1=12308045)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                pass
        elif GetTalkListEntryResult() == 7: # noble scion
            call = t242029_x104(d1=200217, e1=12308046)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                pass
        elif GetTalkListEntryResult() == 8: # cruel fate
            call = t242029_x104(d1=200218, e1=12308047)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                pass
        elif GetTalkListEntryResult() == 9: # waste of skin
            call = t242029_x104(d1=200219, e1=12308048)
            if call.Get() == 1:
                ForceCloseMenu()
            elif call.Done():
                pass
