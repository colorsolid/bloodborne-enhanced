...
def t290117_1():
    """State 0,1"""
    t290117_x1(flag1=6000, flag2=6000, actionbutton1=6100, actionbutton2=6101, actionbutton3=6103, flag3=290, flag4=7)
    Quit()

def t290117_x0():
    """State 0,1"""
    SetEventState(8500+77, 0)
    assert t290117_x7(z1=99999, z2=99999, z3=99999, z4=99999)
    """State 2"""
    return 0

def t290117_x1(flag1=6000, flag2=6000, actionbutton1=6100, actionbutton2=6101, actionbutton3=6103, flag3=290, flag4=7):
    """State 0"""
    while True:
        """State 1"""
        call = t290117_x3(actionbutton1=actionbutton1, actionbutton2=actionbutton2, actionbutton3=actionbutton3, flag3=flag3, flag4=flag4)
        if not GetEventStatus(flag1) or not GetEventStatus(flag2):
            pass
        elif IsMultiplayerInProgress() == 1:
            """State 2"""
            call = t290117_x2(actionbutton1=actionbutton1, flag3=flag3, flag4=flag4)
...
def t290117_x2(actionbutton1=6100, flag3=290, flag4=7):
    """State 0,3"""
    ForceCloseMenu()
    while True:
        """State 2"""
        if GetEventStatus(10007810 + flag3 * 10000 + flag4 * 20) == 1:
            ...
            """State 4"""
            SetTalkTime(0.33)
            assert t290117_x8(flag3=flag3, flag4=flag4)
        """State 1"""
...
def t290117_x3(actionbutton1=6100, actionbutton2=6101, actionbutton3=6103, flag3=290, flag4=7):
    """State 0"""
    while True:
        """State 2"""
        ...
        if not GetEventStatus(10007810 + flag3 * 10000 + flag4 * 20):
            ...
            if GetEventStatus(10007810 + flag3 * 10000 + flag4 * 20) == 1:
                ...
                def WhilePaused():
                    c1_73(1)
                assert (t290117_x8(flag3=flag3, flag4=flag4) and GetEventStatus(10007810 + flag3 * 10000
                        + flag4 * 20) == 1)
        elif (not GetOneLineHelpStatus() and not IsTalkingToSomeoneElse() and not IsClientPlayer() and
            ...
            if GetEventStatus(12100972) == 1:
                ...
                SetTalkTime(0.33)
                call = t290117_x4(flag3=290, flag4=7)
                if call.Done():
                    pass
...
# hunter's dream
def t290117_x4(flag3=290, flag4=7):
    """State 0,1"""
    ...
    if GetGenericDialogButtonResult() == 1:
        ...
        DebugEvent('OK')
        """State 4"""
        call = t290117_x6(flag3=flag3, flag4=flag4, z5=0)
        if call.Get() == 1:
            pass
...
def t290117_x6(flag3=290, flag4=7, z5=0):
    """State 0,1"""
    SetEventState(flag3 * 10000 + 70000100 + flag4 * 1, 1)
    """State 2"""
    return 0

def t290117_x7(z1=99999, z2=99999, z3=99999, z4=99999):
    """State 0,1"""
    DebugEvent('会話判定')
...
def t290117_x8(flag3=290, flag4=7):
    """State 0,1"""
    ...
    if GetEventStatus(999):
        ...
        while True:
            ...
            if GetEventStatus(12100961) or GetEventStatus(12100761):
                ...
                if (GetEventStatus(12110000 + 290 * 10 + 7 * 2) == 0 or GetEventStatus(12110000 + 290 * 10 + 7 * 2 + 1) == 0) and GetEventStatus(12100862) == 1:
...
def t290117_x50():
    ...
    while True:
        ...
        # reawaken
            ...
            """State 15"""
            call = t290117_x40(flag3=1510, flag4=51, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 16"""
...
# warp to lamp
def t290117_x20(flag2=_, flag3=_, action1=_):
    """State 0,3"""
    DebugEvent('Flag judgment')
    if GetEventStatus(12100968) and flag2 * 10 + flag3 == 15103:
        if not GetEventStatus(70002413):
            ...
            assert not IsGenericDialogOpen()
            return 1
    elif GetEventStatus(12100968) and flag2 * 10 + flag3 == 15105:
        if not GetEventStatus(70002401):
            ...
            assert not IsGenericDialogOpen()
            return 1
    elif GetEventStatus(12100968) and flag2 * 10 + flag3 == 15121:
...
# reawaken
def t290117_x40(flag3=_, flag4=_, action1=10010715):
    """State 0,5"""
    if not GetEventStatus(flag3 * 10 + 70000000 + flag4 * 1):
        ...
        if GetGenericDialogButtonResult() == 1:
            ...
            DebugEvent('OK')
            """State 6"""
            call = t290117_x20(flag2=flag3, flag3=flag4, action1=10010715)
            if call.Get() == 1:
                pass
        elif not IsGenericDialogOpen():
            """State 2"""
...
def t290117_x51():
    ...
    while True:
        ...
        if not GetTalkListEntryResult() or not CheckSpecificPersonMenuIsOpen(100, 0):
            ...
            """State 7"""
            call = t290117_x20(flag2=1510, flag3=0, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 8"""
            ...
            """State 9"""
            call = t290117_x20(flag2=1510, flag3=1, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 10"""
            ...
            """State 11"""
            call = t290117_x20(flag2=1510, flag3=2, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 12"""
            ...
            """State 13"""
            call = t290117_x20(flag2=1510, flag3=3, action1=10010722)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 14"""
            ...
            """State 15"""
            call = t290117_x20(flag2=1510, flag3=4, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 16"""
            ...
            """State 17"""
            call = t290117_x20(flag2=1510, flag3=5, action1=10010723)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 18"""
            ...
            """State 19"""
            call = t290117_x20(flag2=1510, flag3=6, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 20"""
            ...
            """State 21"""
            call = t290117_x20(flag2=1510, flag3=7, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 22"""
            ...
            """State 23"""
            call = t290117_x20(flag2=1510, flag3=8, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 24"""
            ...
            """State 25"""
            call = t290117_x20(flag2=1510, flag3=9, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 26"""
            ...
            """State 27"""
            call = t290117_x20(flag2=1510, flag3=10, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 28"""
            ...
            """State 29"""
            call = t290117_x20(flag2=1510, flag3=11, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 30"""
...
def t290117_x52():
    ...
    while True:
        ...
        if not GetTalkListEntryResult() or not CheckSpecificPersonMenuIsOpen(100, 0):
            ...
            """State 7"""
            call = t290117_x20(flag2=1510, flag3=12, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 8"""
            ...
            """State 9"""
            call = t290117_x20(flag2=1510, flag3=13, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 10"""
            ...
            """State 11"""
            call = t290117_x20(flag2=1510, flag3=14, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 12"""
            ...
            """State 13"""
            call = t290117_x20(flag2=1510, flag3=15, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 14"""
            ...
            """State 15"""
            call = t290117_x20(flag2=1510, flag3=16, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 16"""
            ...
            """State 17"""
            call = t290117_x20(flag2=1510, flag3=17, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 18"""
...
def t290117_x53():
    ...
    while True:
        ...
        if not GetTalkListEntryResult() or not CheckSpecificPersonMenuIsOpen(100, 0):
            ...
            """State 7"""
            call = t290117_x20(flag2=1510, flag3=18, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 8"""
            ...
            """State 9"""
            call = t290117_x20(flag2=1510, flag3=19, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 10"""
            ...
            """State 11"""
            call = t290117_x20(flag2=1510, flag3=20, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 12"""
            ...
            """State 13"""
            call = t290117_x20(flag2=1510, flag3=21, action1=10010725)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 14"""
            ...
            """State 15"""
            call = t290117_x20(flag2=1510, flag3=22, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 16"""
            ...
            """State 17"""
            call = t290117_x20(flag2=1510, flag3=23, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 18"""
            ...
            """State 19"""
            call = t290117_x20(flag2=1510, flag3=24, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 20"""
            ...
            """State 21"""
            call = t290117_x20(flag2=1510, flag3=25, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 22"""
...
def t290117_x54():
    ...
    while True:
        ...
        if not GetTalkListEntryResult() or not CheckSpecificPersonMenuIsOpen(100, 0):
            ...
            """State 7"""
            call = t290117_x20(flag2=1510, flag3=26, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 8"""
            ...
            """State 9"""
            call = t290117_x20(flag2=1510, flag3=27, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 10"""
            ...
            """State 11"""
            call = t290117_x20(flag2=1510, flag3=28, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 12"""
            ...
            """State 13"""
            call = t290117_x20(flag2=1510, flag3=29, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 14"""
            ...
            """State 15"""
            call = t290117_x20(flag2=1510, flag3=30, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 16"""
            ...
            """State 17"""
            call = t290117_x20(flag2=1510, flag3=31, action1=10010715)
            if call.Done():
                """State 18"""
                return 0
            elif call.Get() == 1:
            ...
            """State 19"""
            call = t290117_x20(flag2=1510, flag3=32, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 20"""
            ...
            """State 21"""
            call = t290117_x20(flag2=1510, flag3=33, action1=10010715)
            if call.Done():
                """State 22"""
                return 0
            elif call.Get() == 1:
...
def t290117_x55():
    ...
    while True:
        ...
        if not GetTalkListEntryResult() or not CheckSpecificPersonMenuIsOpen(100, 0):
            ...
            """State 7"""
            call = t290117_x20(flag2=1510, flag3=34, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 8"""
            ...
            """State 9"""
            call = t290117_x20(flag2=1510, flag3=35, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 10"""
            ...
            """State 11"""
            call = t290117_x20(flag2=1510, flag3=36, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 12"""
            ...
            """State 13"""
            call = t290117_x20(flag2=1510, flag3=37, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 14"""
            ...
            """State 15"""
            call = t290117_x20(flag2=1510, flag3=38, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 16"""
            ...
            """State 17"""
            call = t290117_x20(flag2=1510, flag3=39, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 18"""
            ...
            """State 19"""
            assert t290117_x20(flag2=1510, flag3=40, action1=10010715)
            """State 20"""
            return 0
        elif GetTalkListEntryResult() == 16:
            """State 21"""
            call = t290117_x20(flag2=1510, flag3=41, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 22"""
            ...
            """State 23"""
            call = t290117_x20(flag2=1510, flag3=42, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 24"""
            ...
            """State 25"""
            call = t290117_x20(flag2=1510, flag3=43, action1=10010715)
            if call.Get() == 1:
                pass
            elif call.Done():
                """State 26"""
...
def t290117_x116(flag1=0):
    ...
    while True:
        ...
        if GetTalkListEntryResult() == 1:
            ...
            assert t290117_x117(flag1=flag1, z1=72100300+70)
            return 0
        elif GetTalkListEntryResult() == 2:
            """State 10"""
            DebugEvent('ダンジョン_2F')
            """State 40"""
            SetEventState(12106000, 1)
            assert t290117_x117(flag1=flag1, z1=72100301+70)
            return 0
        elif GetTalkListEntryResult() == 3:
            """State 4"""
            DebugEvent('ダンジョン_3F')
            """State 41"""
            SetEventState(12106000, 1)
            assert t290117_x117(flag1=flag1, z1=72100302+70)
            return 0
        elif GetTalkListEntryResult() == 4:
            """State 7"""
            DebugEvent('ダンジョン_4F')
            """State 42"""
            SetEventState(12106000, 1)
            assert t290117_x117(flag1=flag1, z1=72100303+70)
            return 0
        elif GetTalkListEntryResult() == 5:
            """State 11"""
            DebugEvent('ダンジョン_5F')
            """State 43"""
            SetEventState(12106000, 1)
            assert t290117_x117(flag1=flag1, z1=72100304+70)
            return 0
        elif GetTalkListEntryResult() == 6:
            """State 8"""
            DebugEvent('ダンジョン_6F')
            """State 44"""
            SetEventState(12106000, 1)
            assert t290117_x117(flag1=flag1, z1=72100305+70)
            return 0
        elif GetTalkListEntryResult() == 7:
            """State 9"""
            DebugEvent('ダンジョン_7F')
            """State 45"""
            SetEventState(12106000, 1)
            assert t290117_x117(flag1=flag1, z1=72100306+70)
            return 0
        elif GetTalkListEntryResult() == 8:
            """State 12"""
            DebugEvent('ダンジョン_8F')
            """State 46"""
            SetEventState(12106000, 1)
            assert t290117_x117(flag1=flag1, z1=72100307+70)
            return 0
        elif GetTalkListEntryResult() == 9:
            """State 13"""
            DebugEvent('ダンジョン_9F')
            """State 47"""
            SetEventState(12106000, 1)
            assert t290117_x117(flag1=flag1, z1=72100308+70)
            return 0
        elif GetTalkListEntryResult() == 10:
            """State 14"""
            ...
            """State 48"""
            SetEventState(12106000, 1)
            assert t290117_x117(flag1=flag1, z1=72100309+70)
            return 0
...
def t290117_x117(flag1=72100421, z1=_):
    """State 2"""
    SetEventState(z1, 1)
    """State 3"""
    return 0
