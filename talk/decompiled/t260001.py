...
def t260001_x20(flag2=_, flag3=_, action1=_):
    ...
    if GetEventStatus(12100968) and flag2 * 10 + flag3 == 13303: # 10003
        if not GetEventStatus(70002413):
            ...
            assert not IsGenericDialogOpen()
            return 1
    elif GetEventStatus(12100968) and flag2 * 10 + flag3 == 13305: # 10005
        if not GetEventStatus(70002401):
            ...
            assert not IsGenericDialogOpen()
            return 1
    elif GetEventStatus(12100968) and flag2 * 10 + flag3 == 13321: # 10021
