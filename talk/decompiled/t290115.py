    ...
    while True:
        ...
        if GetEventStatus(12100961) or GetEventStatus(12100761):
            ...
            if (
                ...
                and (
                    GetEventStatus(12110000 + 290 * 10 + 5 * 2) == 0 
                    or GetEventStatus(12110000 + 290 * 10 + 5 * 2 + 1) == 0
                )
            ):
