...
def t220000_x20(flag2=_, flag3=_, action1=_):
    ...
    if GetEventStatus(12100968) and flag2 * 10 + flag3 == 11203: # 10003
        if not GetEventStatus(70002413):
            ...
            assert not IsGenericDialogOpen()
            return 1
    elif GetEventStatus(12100968) and flag2 * 10 + flag3 == 11205: # 10005
        if not GetEventStatus(70002401):
            ...
            assert not IsGenericDialogOpen()
            return 1
    elif GetEventStatus(12100968) and flag2 * 10 + flag3 == 11221: # 10021
