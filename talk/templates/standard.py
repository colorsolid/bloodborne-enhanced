...
def txxxxxx_x0():
    """State 0,1"""
    SetEventState(8500+<LAMP_OFFSET>, 0)
...
def txxxxxx_x60(action1=_):
    ...
    if not GetEventStatus(<FLAG_3> * 10 + 70000000 + <FLAG_4> * 1) or GetEventStatus(12100868) == 1:
        if GetEventStatus(12100858) and GetEventStatus(12100861):
            ...
            SetEventState(8500+<LAMP_OFFSET>, 1)
        else:
            pass
        while True:
            """State 1"""
            ...
            # offer insight / kindle
                ...
                SetEventState(8100+<LAMP_OFFSET>, 1)
                def WhilePaused():
                    SetTalkTime(0.33)
                assert not IsGenericDialogOpen()
            <REMATCH_MENU_CALL>
...
def txxxxxx_x20(flag2=_, flag3=_, action1=_):
    ...
    if GetEventStatus(12100968) and flag2 * 10 + flag3 == <DEACTIVATE_1>: # gascoigne
        ...
        if not GetEventStatus(70002401):
            ...
            assert not IsGenericDialogOpen()
            return 1
    elif GetEventStatus(12100968) and flag2 * 10 + flag3 == <DEACTIVATE_3>: # g
