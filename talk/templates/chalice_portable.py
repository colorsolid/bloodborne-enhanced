...
def txxxxxx_x116(flag1=0):
    ...
    while True:
        ...
        if GetTalkListEntryResult() == 1:
            ...
            DebugEvent('ダンジョン_2F')
            """State 40"""
            assert txxxxxx_x137(flag1=8614)
            return 0
        elif GetTalkListEntryResult() == 3:
            """State 4"""
            DebugEvent('ダンジョン_3F')
            """State 41"""
            assert txxxxxx_x137(flag1=8613)
            return 0
        elif GetTalkListEntryResult() == 4:
            """State 7"""
            DebugEvent('ダンジョン_4F')
            """State 42"""
            assert txxxxxx_x137(flag1=8613, flag2=8614)
            return 0
        elif GetTalkListEntryResult() == 5:
            """State 11"""
            DebugEvent('ダンジョン_5F')
            """State 43"""
            assert txxxxxx_x137(flag1=8612)
            return 0
        elif GetTalkListEntryResult() == 6:
            """State 8"""
            DebugEvent('ダンジョン_6F')
            """State 44"""
            assert txxxxxx_x137(flag1=8612, flag2=8614)
            return 0
        elif GetTalkListEntryResult() == 7:
            """State 9"""
            DebugEvent('ダンジョン_7F')
            """State 45"""
            assert txxxxxx_x137(flag1=8612, flag2=8613)
            return 0
        elif GetTalkListEntryResult() == 8:
            """State 12"""
            DebugEvent('ダンジョン_8F')
            ...
            assert txxxxxx_x137(flag1=8612, flag2=8613, flag3=8614)
            return 0
        elif GetTalkListEntryResult() == 9:
            """State 13"""
            DebugEvent('ダンジョン_9F')
            """State 47"""
            assert txxxxxx_x137(flag1=8611)
            return 0
        elif GetTalkListEntryResult() == 10:
            """State 14"""
