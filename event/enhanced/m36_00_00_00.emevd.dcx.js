...
$Event(0, Default, function() {
    ...
    $InitializeEvent(0, 13604740);
    $InitializeEvent(0, 13604742);
    $InitializeEvent(0, 13600000);
    $InitializeEvent(0, 13600010);
    $InitializeEvent(0, 13601090);
    $InitializeEvent(0, 13601100);
    $InitializeEvent(0, 13601101);
    $InitializeEvent(0, 13601102);
    $InitializeEvent(0, 13601103);
    $InitializeEvent(0, 13601104);
    $InitializeEvent(0, 13601105);
    ...
    $InitializeEvent(0, 13604801);
    $InitializeEvent(0, 13604802);
    $InitializeEvent(0, 13604803);
    $InitializeEvent(0, 13604805);
    $InitializeEvent(0, 13604806);
    $InitializeEvent(0, 13604807);
    $InitializeEvent(0, 13604820);
    $InitializeEvent(0, 13604830);
    $InitializeEvent(0, 13604840);
    $InitializeEvent(0, 13604850);
    $InitializeEvent(0, 13601802);
    $InitializeEvent(0, 13601803);
    ...
    $InitializeEvent(27, 13605200, 3600456, 3602455, 0, 3603456, 1, 1);
    $InitializeEvent(28, 13605200, 3600474, 3602474, 0, 3603474, 0, 0);
    $InitializeEvent(29, 13605200, 3600475, 3602474, 0, 3603475, 1, 1);
    ...
    $InitializeEvent(5, 13605400, 3600239, 7012, 404008, 7013, 404008, 3602240, 0.75, 0.75);
    $InitializeEvent(6, 13605400, 3600240, 7012, 404004, 7013, 404004, 3602240, 0.25, 0.25);
    $InitializeEvent(7, 13605400, 3600241, 7012, 404008, 7013, 404008, 3602240, 0, 0);
    $InitializeEvent(8, 13605400, 3600242, 7012, 404004, 7013, 404004, 3602240, 0.5, 0.5);
    ...
    $InitializeEvent(12, 13605400, 3600247, 7018, 404014, 7019, 404014, 3602246, 0.5, 0.5);
    ...
    $InitializeEvent(17, 13605400, 3600400, 7010, 407022, 3001, 407020, 3602400, 0, 1);
    $InitializeEvent(18, 13605400, 3600401, 7010, 407012, 7001, 407010, 3602400, 0, 1);
    $InitializeEvent(19, 13605400, 3600402, 7010, 407012, 7001, 407010, 3602400, 0, 1);
    $InitializeEvent(20, 13605400, 3600403, 7010, 407012, 7001, 407010, 3602400, 0, 1);
    $InitializeEvent(21, 13605400, 3600404, 7010, 407022, 3001, 407020, 3602400, 0, 1);
    $InitializeEvent(22, 13605400, 3600405, 7010, 407012, 7001, 407010, 3602400, 0, 1);
    $InitializeEvent(25, 13605400, 3600408, 7010, 407022, 3001, 407020, 3602408, 0, 1);
    $InitializeEvent(26, 13605400, 3600409, 7010, 407012, 7001, 407010, 3602408, 0, 1);
    $InitializeEvent(27, 13605400, 3600410, 7010, 407022, 3001, 407020, 3602408, 0, 1);
    $InitializeEvent(28, 13605400, 3600411, 7010, 407012, 7001, 407010, 3602408, 0, 1);
    $InitializeEvent(29, 13605400, 3600412, 7010, 407012, 7001, 407010, 3602412, 0, 0);
    $InitializeEvent(30, 13605400, 3600413, 7010, 407012, 7001, 407010, 3602412, 1, 1);
    $InitializeEvent(33, 13605400, 3600416, 7010, 407022, 3001, 407020, 3602416, 0, 0);
    $InitializeEvent(34, 13605400, 3600417, 7010, 407012, 7001, 407010, 3602416, 1, 1);
    $InitializeEvent(35, 13605400, 3600418, 7010, 407012, 7001, 407010, 3602416, 0.5, 0.5);
    $InitializeEvent(36, 13605400, 3600419, 7010, 407012, 7001, 407010, 3602419, 0, 0);
    $InitializeEvent(37, 13605400, 3600424, 7010, 407022, 3001, 407020, 3602424, 0.5, 0.5);
    $InitializeEvent(38, 13605400, 3600425, 7010, 407012, 7001, 407010, 3602424, 0, 0);
    $InitializeEvent(39, 13605400, 3600426, 7010, 407012, 7001, 407010, 3602424, 1, 1);
    ...
    $InitializeEvent(2, 13605480, 3600477, 7014, 407000, 7015, 407000, 3602476, 0.5, 30);
    ...
    $InitializeEvent(1, 13605490, 3600266, 7012, 404018, 7013, 404019, 3600314, 0.5, 0.5);
    $InitializeEvent(2, 13605490, 3600267, 7014, 404018, 7015, 404019, 3600314, 1, 1);
    $InitializeEvent(3, 13605490, 3600263, 7012, 404018, 7013, 404019, 3600265, 0.5, 0.5);
    $InitializeEvent(4, 13605490, 3600264, 7012, 404018, 7013, 404019, 3600265, 1, 1);
    $InitializeEvent(1, 13605500, 3600207, 7006, 404002, 7007, 404002, 3602206, 4, 4);
    ...
    $InitializeEvent(0, 13605540, 3600210, 0, 8, 404040, 404000);
    $InitializeEvent(1, 13605540, 3600300, 0, 8, 406001, 406000);
    $InitializeEvent(2, 13605540, 3600500, 3602470, 4, 256901, 256900);
    $InitializeEvent(3, 13605540, 3600501, 3602470, 4, 256901, 256900);
    $InitializeEvent(4, 13605540, 3600218, 0, 1, 404011, 404010);
    $InitializeEvent(5, 13605540, 3600220, 0, 4, 404011, 404010);
    $InitializeEvent(6, 13605540, 3600221, 0, 4, 404011, 404010);
    $InitializeEvent(0, 13605560, 3600331, 3602331, 4);
    $InitializeEvent(0, 13605600, 3600500, 3600510);
    $InitializeEvent(1, 13605600, 3600501, 3600511);
    $InitializeEvent(0, 13605605);
    $InitializeEvent(0, 13605606);
    $InitializeEvent(0, 13605799);
    $InitializeEvent(0, 13605720, 3600206);
    $InitializeEvent(1, 13605720, 3600314);
    $InitializeEvent(0, 13605740, 3600215, 3602215, 3600720, 2);
    $InitializeEvent(1, 13605740, 3600219, 3602218, 3600721, 2);
    $InitializeEvent(2, 13605740, 3600250, 3602250, 3600722, 2);
    $InitializeEvent(0, 13605750);
    $InitializeEvent(0, 13605751);
    ...
    $InitializeEvent(0, 13600995);
    $InitializeEvent(0, 13600942, 6, 10);
    $InitializeEvent(0, 13600943, 73600300, 43600);
    $InitializeEvent(0, 13600944);
...
$Event(13604700, Restart, function(chrEntityId, eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4) {
...
L0:
    ...
    onlineFlagMapChrSp &= IsOnline() && !EventFlag(eventFlagId2) && !EventFlag(eventFlagId3) && PlayerInMap(36, 0);
...
$Event(13604710, Restart, function(chrEntityId, eventFlagId, eventFlagId2, eventFlagId3) {
...
$Event(13604720, Restart, function(chrEntityId, eventFlagId, eventFlagId2, eventFlagId3) {
    EndIf(EventFlag(eventFlagId2));
    WaitFor(
        EventFlag(eventFlagId)
            && EventFlag(eventFlagId3)
...
$Event(13604730, Restart, function(chrEntityId, eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4, eventFlagId5, eventFlagId6, eventFlagId7) {
        ...
        WaitFor(
            EventFlag(13601108)
                ...
                && (InArea(10000, 3602102)
                    ...
                    || (EventFlagState(CHANGE, TargetEventFlagType.EventFlag, 13601107)
                        && EventFlag(13601107))));
...
$Event(13601140, Default, function(entityId, hitEntityId) {
...
$Event(13601200, Default, function(objEntityId, objactEventFlag, animationId, objParameterId) {
    if (ThisEventSlot()) {
...
$Event(13601210, Default, function(actionButtonParameterId, areaEntityId, eventFlagId) {
    SetNetworkSyncState(Disabled);
    EndIf(EventFlag(eventFlagId));
...
$Event(13604400, Restart, function(objEntityId) {
    EndIf(ThisEventSlot());
    ...
    if (!dmg.Passed) {
        ShootBullet(3600799, objEntityId, -1, 6310, 0, 0, 0);
...
L0:
    ShootBullet(3600799, objEntityId, -1, 6310, 0, 0, 0);
    ShootBullet(3600799, objEntityId, -1, 6320, 0, 0, 0);
    RequestObjectDestruction(objEntityId, 1);
    PlaySE(objEntityId, SoundType.oObject, 299961000);
});
...
$Event(13601802, Default, function() {
    ...
    EndIf(EventFlag(13601803) || EventFlag(orphan_defeat+13));
    if (ThisEvent()) {
...
$Event(13604840, Default, function() {
    ...
    WaitFor(
        CharacterHasEventMessage(3600800, 40)
            || ElapsedSeconds(4.5)
            || !EntityInRadiusOfEntity(3600800, 10000, 20));
...
$Event(13605200, Restart, function(chrEntityId, areaEntityId, areaEntityId2, patrolInformationEntityId, timeSeconds, value) {
    if (!ThisEventSlot()) {
        WaitFor(
            (CharacterType(10000, TargetType.Alive)
                || CharacterType(10000, TargetType.WhitePhantom))
...
$Event(13605400, Restart, function(chrEntityId, animationId, aiId, playAnimationId, aiId2, areaEntityId, minTimeSeconds, maxTimeSeconds) {
    if (!ThisEventSlot()) {
...
$Event(13605480, Restart, function(chrEntityId, animationId, aiId, playAnimationId, aiId2, areaEntityId, timeSeconds, timeFrames) {
    if (!ThisEventSlot()) {
        SetCharacterAIState(chrEntityId, Disabled);
        ForceAnimationPlayback(chrEntityId, animationId, true, false, false);
        SetCharacterAIId(chrEntityId, aiId);
...
$Event(13605490, Restart, function(chrEntityId, animationId, aiId, playAnimationId, aiId2, chrEntityId2, minTimeSeconds, maxTimeSeconds) {
    if (!ThisEventSlot()) {
        ForceAnimationPlayback(chrEntityId, animationId, true, false, false);
        SetCharacterAIId(chrEntityId, aiId);
        WaitFor(
...
$Event(13605500, Restart, function(chrEntityId, animationId, aiId, playAnimationId, aiId2, areaEntityId, minTimeSeconds, maxTimeSeconds) {
    if (!ThisEventSlot()) {
...
$Event(13605520, Restart, function(chrEntityId, areaEntityId, aiId, aiId2) {
...
$Event(13605540, Restart, function(chrEntityId, areaEntityId, targetDistance, aiId, aiId2) {
    if (!ThisEventSlot()) {
        SetCharacterAIId(chrEntityId, aiId);
        WaitFor(
...
$Event(13605560, Restart, function(chrEntityId, areaEntityId, targetDistance) {
    EndIf(ThisEventSlot());
    SetCharacterAIState(chrEntityId, Disabled);
    WaitFor(
...
$Event(13605600, Restart, function(hitEntityId, chrEntityId) {
    SetCharacterGravity(chrEntityId, Disabled);
    if (!ThisEventSlot()) {
...
$Event(13605700, Restart, function(chrEntityId, playAnimationId, eventFlagId) {
    if (!EventFlag(eventFlagId)) {
        ...
        WaitFor(
            CharacterAIState(chrEntityId, AIStateType.Recognition)
                || CharacterAIState(chrEntityId, AIStateType.Combat));
        SetEventFlag(eventFlagId, ON);
        RotateCharacter(chrEntityId, 10000, playAnimationId, true);
    }
L0:
...
$Event(13605720, Restart, function(chrEntityId) {
...
$Event(13605740, Restart, function(chrEntityId, areaEntityId, chrEntityId2, targetDistance) {
    EndIf(ThisEvent());
    SetCharacterAIState(chrEntityId, Disabled);
...
$Event(13605750, Restart, function() {
    if (!ThisEventSlot()) {
        ...
        chrArea |= CharacterAIState(3600201, AIStateType.Recognition)
            || CharacterAIState(3600201, AIStateType.Combat);
...
$Event(13605770, Restart, function(chrEntityId, areaEntityId, minTimeSeconds, maxTimeSeconds) {
    EndIf(ThisEventSlot());
    SetCharacterAIState(chrEntityId, Disabled);
    SetCharacterGravity(chrEntityId, Disabled);
    SetCharacterMaphits(chrEntityId, true);
...
$Event(13605900, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, areaEntityId, areaEntityId2, eventFlagId4) {
...
$Event(13605910, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, areaEntityId, areaEntityId2) {
    EndIf(EventFlag(1730));
    EndIf(EventFlag(eventFlagId3));
    EndIf(EventFlag(eventFlagId2));
    WaitFor(
...
$Event(13605920, Restart, function(chrEntityId, eventFlagId, eventFlagId2, areaEntityId, areaEntityId2, eventFlagId3, eventFlagId4, entityId) {
...
$Event(13605921, Restart, function(chrEntityId, eventFlagId, eventFlagId2, areaEntityId, areaEntityId2, eventFlagId3, eventFlagId4, entityId) {
    RequestCharacterAICommand(chrEntityId, 30, 0);
    RequestCharacterAIReplan(chrEntityId);
    SetCharacterInvincibility(chrEntityId, Enabled);
    SetCharacterAnimationState(chrEntityId, Disabled);
    ...
    if (!EventFlag(eventFlagId)) {
        ...
        WaitFor(
            !EventFlag(1730)
                ...
                && (area || area2));
        if (!area2.Passed) {
            WarpCharacterAndSetFloor(chrEntityId, TargetEntityType.Area, entityId, -1, 3604027);
        } else {
            WarpCharacterAndSetFloor(chrEntityId, TargetEntityType.Area, 3602917, -1, 3604027);
        }
        RequestCharacterAICommand(chrEntityId, -1, 0);
        RequestCharacterAIReplan(chrEntityId);
        SetCharacterInvincibility(chrEntityId, Disabled);
...
$Event(13605930, Restart, function(chrEntityId, eventFlagId, eventFlagId2, areaEntityId, areaEntityId2, eventFlagId3) {
    EndIf(EventFlag(1730));
    EndIf(EventFlag(eventFlagId2));
    WaitFor(
        EventFlag(eventFlagId)
...
$Event(13605940, Restart, function(chrEntityId, eventFlagId, eventFlagId2, itemLotId, chrEntityId2) {
...
$Event(13600900, Default, function(chrEntityId, eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4) {
    EndIf(!CharacterType(10000, TargetType.Alive));
...
$Event(13600940, Default, function(chrEntityId) {
    if (CharacterType(10000, TargetType.Alive)) {
...
L1:
    ...
    SetDistanceLimitForConversationStateProcessing(chrEntityId, 35);
    EndEvent();
});

// Fishing village priest_Item acquisition_Fishing villager's exposed head
$Event(13600943, Default, function(eventFlagId, itemLotId) {
    EndIf(EventFlag(eventFlagId));
    EndIf(!CharacterType(10000, TargetType.Alive));
    WaitFor(EventFlag(eventFlagId));
...
$Event(13600941, Default, function(eventFlagId, eventFlagId2) {
    EndIf(!CharacterType(10000, TargetType.Alive));
...
$Event(13600942, Default, function(minTimeSeconds, maxTimeSeconds) {
    EndIf(!CharacterType(10000, TargetType.Alive));
...
$Event(13600950, Default, function(chrEntityId) {
    if (CharacterType(10000, TargetType.Alive)) {
...
L3:
        if (!AnyBatchEventFlags(1710, 1712)) {
...
L0:
    ...
    ForceAnimationPlayback(chrEntityId, 103151, false, false, false);
    SetCharacterImmortality(chrEntityId, Enabled);
    EndEvent();
L1:
    SetCharacterAnimationState(chrEntityId, Disabled);
    ForceAnimationPlayback(chrEntityId, 103157, false, false, true);
    EndEvent();
});

// Secret seeker_play animation during conversation
$Event(13600951, Default, function(chrEntityId, eventFlagId, eventFlagId2) {
    EndIf(!CharacterType(10000, TargetType.Alive));
    SetEventFlag(eventFlagId, OFF);
    WaitFor(EventFlag(eventFlagId2) && EventFlag(eventFlagId) && HPRatio(chrEntityId) != 0);
    ForceAnimationPlayback(chrEntityId, 103152, false, false, false);
    WaitFor(EventFlag(eventFlagId2) && !EventFlag(eventFlagId) && HPRatio(chrEntityId) != 0);
    ForceAnimationPlayback(chrEntityId, 103151, false, false, false);
    RestartEvent();
});
...
$Event(13600952, Default, function(chrEntityId, eventFlagId, eventFlagId2) {
    EndIf(!CharacterType(10000, TargetType.Alive));
    WaitFor(EventFlag(eventFlagId) && HasDamageType(chrEntityId, 10000, DamageType.Unspecified));
    ForceAnimationPlayback(chrEntityId, 103153, false, false, false);
    ForceCharacterDeath(chrEntityId, true);
    SetEventFlag(eventFlagId2, ON);
});

// Secret Seeker_Real-time initialization
$Event(13600953, Default, function(chrEntityId) {
...
$Event(13600954, Default, function(eventFlagId, eventFlagId2, itemLotId) {
    EndIf(!CharacterType(10000, TargetType.Alive));
    if (EventFlag(eventFlagId)) {
        if (EventFlag(eventFlagId2)) {
            EndEvent();
...
L0:
    WaitFor(EventFlag(eventFlagId2) && CharacterDead(3600905));
    AwardItemLot(itemLotId);
});
...
$Event(13600956, Default, function(chrEntityId, eventFlagId, eventFlagId2) {
    EndIf(!CharacterType(10000, TargetType.Alive));
    ...
    ForceAnimationPlayback(chrEntityId, 103156, false, true, true);
    ForceAnimationPlayback(chrEntityId, 103157, false, false, true);
});
